...
tf.app.flags.DEFINE_float("student_hidden_dropout_keep_prob", 0.9, "")
...
tf.app.flags.DEFINE_float("data_weight", 1.0, "")
tf.app.flags.DEFINE_float("distill_logits_weight", 0.0, "")
