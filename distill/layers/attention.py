...
class MultiHeadScaledDotProductAttention(object):
  ...
  def apply(self, x, y, bias, is_train=True, cache=None, x_presence=None, y_presence=None):
    ...
    tf.summary.image("attention_weights", tf.expand_dims(attention_weights[0],axis=0))
...
class ReversedMultiHeadScaledDotProductAttention(MultiHeadScaledDotProductAttention):
  ...
  def apply(self, x, y, bias, x_presence=None, y_presence=None, presence_temp=1, sparse_attention=True, is_train=True, cache=None):
    ...
    tf.summary.image("assignment_weights", tf.expand_dims(assignment_weights[0], axis=0))
